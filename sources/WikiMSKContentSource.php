...
/**
 * WikiMSK content source.
 */
class WikiMSKContentSource extends MediaWikiContentSource
{
	public function __construct()
	{
		$this->url = 'https://wikimsk.org/wiki';
		$this->apiUrl = 'https://wikimsk.org/w/api.php';
		$this->contentItemQuery['action'] = 'expandtemplates';
		parent::__construct('wikimsk', 'WikiMSK');
